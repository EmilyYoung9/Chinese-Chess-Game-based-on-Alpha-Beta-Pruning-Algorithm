...
class ChinaChess():
    ...
    def piecesInit(self):
        #黑棋
        ChinaChess.piecesList.append(pieces.Che(ChinaChess.player2Color, 0,0))
        ChinaChess.piecesList.append(pieces.Ma(ChinaChess.player2Color, 1, 0))
        ChinaChess.piecesList.append(pieces.Xiang(ChinaChess.player2Color, 2, 0))
        ChinaChess.piecesList.append(pieces.Shi(ChinaChess.player2Color,  3, 0))
        ChinaChess.piecesList.append(pieces.Jiang(ChinaChess.player2Color, 4, 0))
        ChinaChess.piecesList.append(pieces.Shi(ChinaChess.player2Color, 5, 0))
        ChinaChess.piecesList.append(pieces.Xiang(ChinaChess.player2Color, 6, 0))
        ChinaChess.piecesList.append(pieces.Ma(ChinaChess.player2Color, 7, 0))
        ChinaChess.piecesList.append(pieces.Che(ChinaChess.player2Color,  8, 0))

        ChinaChess.piecesList.append(pieces.Pao(ChinaChess.player2Color,  1, 2))
        ChinaChess.piecesList.append(pieces.Pao(ChinaChess.player2Color, 7, 2))

        ChinaChess.piecesList.append(pieces.Bing(ChinaChess.player2Color, 0, 3))
        ChinaChess.piecesList.append(pieces.Bing(ChinaChess.player2Color, 2, 3))
        ChinaChess.piecesList.append(pieces.Bing(ChinaChess.player2Color, 4, 3))
        ChinaChess.piecesList.append(pieces.Bing(ChinaChess.player2Color, 6, 3))
        ChinaChess.piecesList.append(pieces.Bing(ChinaChess.player2Color, 8, 3))

        #红棋
        ChinaChess.piecesList.append(pieces.Che(ChinaChess.player1Color,  0, 9))
        ChinaChess.piecesList.append(pieces.Ma(ChinaChess.player1Color, 1, 9))
        ChinaChess.piecesList.append(pieces.Xiang(ChinaChess.player1Color, 2, 9))
        ChinaChess.piecesList.append(pieces.Shi(ChinaChess.player1Color,  3, 9))
        ChinaChess.piecesList.append(pieces.Jiang(ChinaChess.player1Color, 4, 9))
        ChinaChess.piecesList.append(pieces.Shi(ChinaChess.player1Color,  5, 9))
        ChinaChess.piecesList.append(pieces.Xiang(ChinaChess.player1Color, 6, 9))
        ChinaChess.piecesList.append(pieces.Ma(ChinaChess.player1Color, 7, 9))
        ChinaChess.piecesList.append(pieces.Che(ChinaChess.player1Color,  8, 9))


        ChinaChess.piecesList.append(pieces.Pao(ChinaChess.player1Color,  1, 7))
        ChinaChess.piecesList.append(pieces.Pao(ChinaChess.player1Color,  7, 7))

        ChinaChess.piecesList.append(pieces.Bing(ChinaChess.player1Color, 0, 6))
        ChinaChess.piecesList.append(pieces.Bing(ChinaChess.player1Color, 2, 6))
        ChinaChess.piecesList.append(pieces.Bing(ChinaChess.player1Color, 4, 6))
        ChinaChess.piecesList.append(pieces.Bing(ChinaChess.player1Color, 6, 6))
        ChinaChess.piecesList.append(pieces.Bing(ChinaChess.player1Color, 8, 6))
